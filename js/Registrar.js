...
for (let i in listaProductos) {
    ...
    menu += `${parseInt(i)+1}. ${listaProductos[i].nombre} ($${listaProductos[i].precio})\n`;
}
...
do {
    ...
    compra.cantidad = parseInt(prompt(`Esriba la cantidad que desea llevar...`));
    compra.envio = parseInt(prompt("Seleccionar el tipo de envio (1. Express / 2. Normal)..."));
    ...
    continuar = confirm("Desea ingresar otra compra?");
